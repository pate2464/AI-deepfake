...
export default function NextSteps({ onUploadAnother, className }: NextStepsProps) {
  return (
    <section className={cn("rounded-[24px] border border-white/[0.07] bg-white/[0.03] px-5 py-5", className)}>
      <h3 className="text-base font-semibold text-white">What to do next</h3>
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-7 text-[#c4c4c4] marker:text-[#888]">
      ...
      <p className="mt-4 text-sm text-[#8f8f8f]">
        Need charts, heatmaps, or raw fields? Expand <span className="font-medium text-[#c4c4c4]">Technical analysis</span>{" "}
        below.
      </p>
