    ...
    <section className={cn("rounded-[24px] panel-muted px-5 py-5", className)}>
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-base font-semibold text-[var(--text-primary)]">Why this result</h3>
          ...
          {onViewTechnical ? (
            <button
              ...
              className="mt-4 text-sm font-medium text-[var(--text-secondary)] underline-offset-4 hover:underline"
            >
